  ...
  <v-app id="inspire">
    ...
    >
      <v-list dense>
        ...
        <v-list-item link>
          <v-list-item-action>
            <v-icon large  color="indigo">mdi-delete-forever</v-icon>
          </v-list-item-action>
        ...
        <v-list-item link>
          <v-list-item-action>
            <v-icon large  color="indigo">mdi-exit-to-app</v-icon>
          </v-list-item-action>
    ...
    >
      ...
      <v-toolbar-title>Book Management System</v-toolbar-title>
    </v-app-bar>
