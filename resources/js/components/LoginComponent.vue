              ...
              <v-card-text>
                <v-form>
                  ...
                  <v-text-field
                    ...
                    type="password"
                  ></v-text-field>
                  <v-checkbox v-model="remember_me" label="Remember Me" color="red"></v-checkbox>
                </v-form>
              </v-card-text>
              <v-card-actions>
                <v-spacer></v-spacer>
                <v-btn text large color="error" @click="redirectToRegister()">Register Yourself From Here</v-btn>
